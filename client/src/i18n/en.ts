export default {
  ...
  admin: {
    ...
    confirmDemote: "Are you sure you want to demote this user from admin?",
    confirmDelete:
    ...
    userDemoted: "User demoted from admin",
    ...
    apiKeyDescription: "The API key used for AI translation and summarization",
    saveConfig: "Save Configuration",
    saving: "Saving...",
    confirmApiKeyChange:
      "Are you sure you want to change the API key? This will affect all AI translation and summarization services.",
